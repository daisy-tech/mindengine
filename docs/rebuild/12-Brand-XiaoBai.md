...
> ✅ **修订 v1.1（2026-06）· 头像资产已确认存在（决策 D9 · 已澄清）**：
> `docs/rebuild/xiaobai-avatar.png` **确实存在**：40214 字节、WebP/VP8、800×1448，与 §2.1 描述一致。
> （评审初稿曾误报"缺失"——系扫描工具漏识别二进制文件所致，**实际无需补齐**。）M5 品牌适配直接复制本文件即可。
